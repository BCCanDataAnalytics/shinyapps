$(document).ready(function() {
  $(".navbar .container-fluid .navbar-nav .dropdown .dropdown-menu").each(function(index) {
    ...
    $( this ).addClass("dropdown-menu-" + num);
	  ...
	  $(".dropdown-menu-1").append('<li><a href="https://bccandataanalytics.shinyapps.io/ReleaseNotes" target="_blank">Release Notes</a></li>');
	  ...
	  $(".dropdown-menu-2").append('<li><a href="https://bccandataanalytics.shinyapps.io/StandardizedIncidenceRatio/" target="_blank">BC/Regional: Standardized Cancer Incidence Ratio</a></li>');
	  ...
	  $(".dropdown-menu-3").append('<li><a href="https://bccandataanalytics.shinyapps.io/StandardizedMortalityRatio/" target="_blank">BC/Regional: Standardized Cancer Mortality Ratio</a></li>');
	  ...
	  $(".dropdown-menu-2").append('<li><a href="https://bccandataanalytics.shinyapps.io/LHAstatistics/?main=incidence" target="_blank">Local health area incidence</a></li>');
