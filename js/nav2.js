$(document).ready(function() {
  $(".navbar .container-fluid .navbar-nav .dropdown .dropdown-menu").each(function(index) {
    ...
    $( this ).addClass("dropdown-menu-" + num);
	  ...
	  $(".dropdown-menu-3").append('<li><a href="https://bccandataanalytics.shinyapps.io/StandardizedMortalityRatio/" target="_blank">BC/Regional: AtanSardized Cancer Mortality Ratio</a></li>');
