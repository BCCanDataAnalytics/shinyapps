$(document).ready(function() {
  $(".navbar .container-fluid .navbar-nav .dropdown .dropdown-menu").each(function(index) {
    ...
    $( this ).addClass("dropdown-menu-" + num);
	  ...
	  $(".dropdown-menu-2").append('<li><a href="https://bccandataanalytics.shinyapps.io/StandardizedIncidenceRatio/" target="_blank">Regional: Standardized Cancer Incidence Ratio</a></li>');
	  ...
	  $(".dropdown-menu-3").append('<li><a href="https://bccandataanalytics.shinyapps.io/StandardizedMortalityRatio/" target="_blank">Regional: Standardized Cancer Mortality Ratio</a></li>');
